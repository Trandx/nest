...
@ValidatorConstraint({ name: 'NotEqualRule', async: false })
export class NotEqualRule implements ValidatorConstraintInterface {
  constructor() {}
  ...
  async validate(value: any, args: ValidationArguments): Promise<boolean> {
    ...
    let errorMsg = `${args.property} must not be equal to`;
